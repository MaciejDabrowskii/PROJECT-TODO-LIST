...
const todoDivsEvents = () => {
    ...
    const todoMoveButtonEvent = (moveButton, todoIndex, todoDiv ) => {
        if (_project_menager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectsArray().length > 0) {
            moveButton.addEventListener('click', (e) =>{
                ...
                // const moveTodoProjects = [...document.getElementsByClassName('.moveTodoProjects')];
                // moveTodoProjects.forEach((element) => {
                //     element.remove();
                // });
    ...
    // click
    // check for projects if none return
    // if present check for targeted project
    
    // if home print all projects
    
    // if project print home and all other projects
